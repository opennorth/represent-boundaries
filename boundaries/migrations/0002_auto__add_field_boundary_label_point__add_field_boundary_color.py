...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('boundaries_boundary', 'label_point', self.gf('django.contrib.gis.db.models.fields.PointField')(blank=True, null=True), keep_default=False)

        # Adding field 'Boundary.color'
        db.add_column('boundaries_boundary', 'color', self.gf('jsonfield.fields.JSONField')(default='', blank=True, null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Boundary.color'
        db.delete_column('boundaries_boundary', 'color')
    ...
    models = {
        'boundaries.boundary': {
            ...
            'color': ('jsonfield.fields.JSONField', [], {'blank': 'True'}),
            'external_id': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'label_point': ('django.contrib.gis.db.models.fields.PointField', [], {'null': 'True'}),
