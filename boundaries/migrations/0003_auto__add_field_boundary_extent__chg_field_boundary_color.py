...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('boundaries_boundary', 'extent', self.gf('jsonfield.fields.JSONField')(null=True, blank=True), keep_default=False)

        # Changing field 'Boundary.color'
        db.alter_column('boundaries_boundary', 'color', self.gf('jsonfield.fields.JSONField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Boundary.color'
        db.alter_column('boundaries_boundary', 'color', self.gf('jsonfield.fields.JSONField')(default=''))
    ...
    models = {
        'boundaries.boundary': {
            ...
            'color': ('jsonfield.fields.JSONField', [], {'null': 'True', 'blank': 'True'}),
            'extent': ('jsonfield.fields.JSONField', [], {'null': 'True', 'blank': 'True'}),
            'external_id': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'label_point': ('django.contrib.gis.db.models.fields.PointField', [], {'null': 'True', 'blank': 'True'}),
